            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php include('core/controllerPHP/loginController.php'); ?>
                            </div>
                        </div>
                        <form action="login" method="POST" class="md-float-material">
                            <div class="auth-box">
                                ...
                                <!-- <input type="hidden" name="continue" value="<?php //echo htmlspecialchars($continueURL); ?>">                                 -->
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="login" class="btn btn-primary btn-round btn-md btn-block waves-effect text-center m-b-20">Sign in</button>
                                    </div>
                                </div>
