...
$(document).ready(function(){
    ...
    // With Placeholder
    $(".js-multiple-brand").select2({
        placeholder: "Brand"
    });

    // With Placeholder
    $(".js-multiple-colour").select2({
        placeholder: "Colour"
    });

    // With Placeholder
    $(".js-multiple-size").select2({
        placeholder: "Size"
    });

    // With Placeholder
    $(".js-multiple-length").select2({
        placeholder: "Length"
    });

    // With Placeholder
    $(".js-multiple-shape").select2({
        placeholder: "Shape"
    });

    // With Placeholder
    $(".js-multiple-template").select2({
