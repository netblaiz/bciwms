                                ...
                                <ul class="pcoded-submenu">
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            ...
                                            <li class="">
                                                <a href="chart-knob.html" data-i18n="nav.charts.know-chart"> <span class="pcoded-micon"><i class="ti-angle-right"></i></span> <span class="pcoded-mtext">Knob chart</span> <span class="pcoded-mcaret"></span> </a>
                                            </li>
                                            <li class="">
