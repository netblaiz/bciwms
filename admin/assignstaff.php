...
<?php
if (isset($_SESSION["client_id"]) && isset($_SESSION["personnel_id"])) {
...
<head>
    <title> BCI WMS | Assign Staff </title>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 m-auto">
                                                ...
                                                <?php include('../core/controllerPHP/assignstaffController.php'); ?>
                                                
                                                <div class="card card-border-default">
                                                    <div class="card-header">
                                                        <h5> Assign Field Staff </h5>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <form action="assignstaff" method="POST">
                                                                    ...
                                                                    <input type="hidden" name="personnel_id" class="form-control" placeholder="Personnel Id" required="required" value="<?php echo $personnel_idStored; ?>">

                                                                    <div class="form-group row">
                                                                        <div class="col-xs-12 col-sm-6">
                                                                            <label class="control-label"><b> Select field Staff </b></label>
                                                                            <select name="field_staff_id" class="form-control" required >
                                                                                <option value="0"> No Staff </option>
                                                                                <?php
                                                                                    $r_fieldstaff = r_fieldstaff($con);
                                                                                    $r_fieldstaff_data = json_decode($r_fieldstaff, true);

                                                                                    if (!empty($r_fieldstaff_data)) {
                                                                                        foreach ($r_fieldstaff_data as $key => $value) {
                                                                                            echo '
                                                                                            <option value="'.$value['id'].'">'.$value['full_name'].'</option>
                                                                                            ';
                                                                                        }
                                                                                    } else {
                                                                                        echo '<option> No Field Staff </option>';
                                                                                    }
                                                                                ?>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-xs-12 col-sm-6">
                                                                            <button type="submit" name="assignstaff" id="assignstaff" class=" btn btn-primary btn-round waves-effect waves-light"><i class="icofont icofont-link"></i> Assign Staff </button>
                                                                        </div>
                                                                    </div>
