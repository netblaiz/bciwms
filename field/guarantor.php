...
<head>
    <title> BCI WMS | Guarantor Verification Form </title>
                                            ...
                                            <div class="col-md-8 m-auto">
                                                <div class="card card-border-default">
                                                    <div class="card-header">
                                                        <h5 class="text-inverse"> Guarantor's Confirmation: <?php echo fetchPersonnelName($con, $personnel_idStored); ?> </h5>
                                                    </div>
                                                    <div class="card-block icon-btn">
                                                        <form action="guarantor" method="POST">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Guarantor's Residential Address </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> Name & Address of Employer (If any) </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> Business Name & Address (If Self Employed) </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="state_origin" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Are you aware this person made you his Guarantor</label>
                                                                        <select name="gender" id="gender" class="form-control" required>
                                                                            <option></option>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">What other name(s) do you know the Personnel by</label>
                                                            ...
                                                            <br>
                                                            <h6 class="m-b-20"><strong> Please select the appropriate option to indicate your assessement of the Personnel with regard to the following qualities: </strong></h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> Futher comment(s)/issue(s) on the Personnel </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-8">
                                                                    Are you willing to indemnify the Personnel's employer should he perpetuate any deliberate damage, syndicate theft or loss of any kind on the part of the employer?
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        <!-- <label class="control-label"> Are you willing to indemnify the Personnel's employer should he perpetuate any deliberate damage, syndicate theft or loss of any kind on the part of the employer? </label> -->
                                                                        <select name="indemnify_status" class="form-control" required>
                                                                            <option value="Husband"> Yes </option>
                                                                            <option value="No"> No </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> If No, state your reasons(s)</label>
                                                                        <textarea class="form-control" name="indemnify_reason"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> Your Recommendation(s) </label>
                                                            ...
                                                            <br>
                                                            <p>Please upload a covering letter attesting to sincerity of the information</p>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">

                                                                        <button type="submit" class="btn btn-primary btn-round" name="submit_guarantor" id="submit_guarantor"> <i class="icofont icofont-save"></i> Submit </button>

                                                                        <!-- <a href="guarantoruploads" class="btn btn-primary btn-round tooltip-btn <?php //echo $disable5; ?>" data-toggle="tooltip" data-placement="bottom" title="Guarantor Files"><i class="icofont icofont-files"></i> Upload Confirmations </a> -->
