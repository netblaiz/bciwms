                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 m-auto filter-bar icon-btn">
                                                <?php include('_includes/reference_nav.php'); ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8 m-auto">
                                                <div class="card card-border-default">
                                                    ...
                                                    <div class="card-header">
                                                        <h5 class="text-inverse"> REFERENCE FORM SUMMARY: <?php echo fetchPersonnelName($con, $personnel_id_set)." (".fetchUserName($con, $client_id_set).")"; ?> </h5>
                                                    </div>
                                                    ...
                                                    <div class="card-block marketing-card p-30">
                                                        ...
                                                        <div class="row m-b-10">
                                                            <div class="col-sm-12 col-xs-12 p-20" style="border: solid 1px #e6e6e6;">
                                                                <h6 class="text-uppercase"><strong> Reference Details</strong></h6>
                                                                <div class="row">
                                                                    <div class="col-sm-6 col-xs-12">
                                                                        ...
                                                                        <p class="m-0 m-t-10"><strong> Email Address: </strong> godwinoluyomi@gmail.com </p>
                                                                    ...
                                                                    <div class="col-sm-6 col-xs-12">
                                                                        ...
                                                                        <p class="m-0 m-t-10"><strong> Name Employer: </strong> Lorem Ipsum </p>
                                                            ...
                                                            <div class="col-sm-8 col-xs-12 p-20" style="border: solid 1px #e6e6e6;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-xs-12">
                                                                        <p class="m-0 m-t-10"><strong> Overall Comment/Assessment of Personnel: </strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
