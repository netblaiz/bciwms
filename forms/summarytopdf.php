                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 m-auto filter-bar icon-btn">
                                                <nav class="navbar navbar-light bg-faded p-10 m-b-10" style="padding-bottom: 20px;">
                                                    <ul class="nav navbar-nav m-t-10">
                                                        <li class="nav-item">
                                                            <a href="companyuploads" class="btn btn-primary btn-round tooltip-btn <?php echo $disable5; ?>" data-toggle="tooltip" data-placement="bottom" title="Company Files"><i class="icofont icofont-files"></i> Upload Covering Letter </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <button class="btn btn-inverse btn-icon tooltip-btn <?php echo $disable7; ?>" data-toggle="tooltip" data-placement="bottom" title="Print Summary" onclick="exporthtml()"><i class="icofont icofont-printer"></i></button>
                                                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 m-auto">
                                                <div class="card card-border-default" id="root">

                                                    <div class="card-header">
                                                        <h5 class="text-inverse"> ASSESSMENT/REFERENCE SUMMARY </h5>
                                                    </div>
...
<![endif]-->
    ...
    <script src="../../components/html2pdf/html2pdf.bundle.js"></script>
