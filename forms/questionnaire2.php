...
session_start();
// Disable Navbar
$disable0=""; $disable1=""; $disable2="disabled"; $disable3=""; $disable4=""; $disable5=""; $disable6=""; $disable7="disabled";
                                            ...
                                            <div class="col-md-8 m-auto">
                                                <div class="card card-border-default">
                                                    <div class="card-header">
                                                        <h5 class="text-inverse"> Professional Certificates: <?php echo fetchPersonnelName($con, $personnel_id_set)." (".fetchUserName($con, $client_id_set).")"; ?> </h5>
                                                    </div>
                                                    <div class="card-block icon-btn">

                                                        <!-- <form action="questionnaire2/<?php //echo $wms_form_tokenStored; ?>" method="POST"> -->

                                                        <form method="POST" id="questionnaire2Form">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Name of Professional Body</label>
                                                                        <input type="text" class="form-control" name="professsional_body" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="membership_no" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Membership Status</label>
                                                                        <input type="text" class="form-control" name="membership_status" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Membership Start Date</label>
                                                                        <input type="text" class="form-control" name="membership_date" id="dropper-default1" placeholder="dd-mm-yyyy" required/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <button type="submit" class="btn btn-primary btn-round" name="submit_questionnaire2" id="submit_questionnaire2"> <i class="icofont icofont-save"></i> Save </button>

                                                                        <a href="../questionnaire3/<?php echo $wms_form_tokenStored; ?>" class="btn btn-inverse btn-round"> Next Form <i class="icofont icofont-rounded-right"></i></a>
                                                            ...
                                                            <hr>
                                                            <h6 class="m-b-20"><strong> Saved Professional Certificates </strong></h6>
                                                            <div class="row">
                                                                <div class="col-sm-12">
...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('form#questionnaire2Form').submit(function(event) {
                ...
                $.ajax({
                    url:"../../core/controllerAjax/questionnaire2Controller.php",
                    method:"POST",
                    data:formData,
                    async:false,
            ...
            function load_previous() {
                ...
                $.ajax({
                    url:"../../core/controllerAjax/questionnaire2PullController.php",
                    method:"POST",
                    data: {
