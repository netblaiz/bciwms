...
if (isset($_SESSION["wms_user_id"])) { 
    ...
    if ($_SESSION["access_level"]=="2" || $_SESSION["access_level"]=="3" || $_SESSION["access_level"]=="4" || $_SESSION["access_level"]=="5") {
...
<head>
    <title> BCI WMS | Self Service </title>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header table-card-header">
                                                        <h5>  <?php echo fetchUserName($con, $wms_user_idStored); ?> Personnels </h5>
                                                    </div>
                                ...
                                <?php
                                    $r_client_personnels = r_client_personnels($con, $wms_user_idStored);
                                        ...
                                        foreach ($r_client_personnels_data as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    ...
                                                    <form action="index" method="POST" class="m-l-5 m-r-5">

                                                        <input type="hidden" name="personnel_id" value="'.$value['id'].'" required>';

                                                        if ($value['personnel_status']=="1") {
                                                            echo '
                                                            <button type="submit" name="downloadreport" class="btn btn-inverse btn-sm btn-round tooltip-btn" data-toggle="tooltip" data-placement="bottom" title="Download Report"><i class="icofont icofont-ebook"></i> Download Report </button>
                                                                ';
                                                        } else {
                                                            echo '
                                                                <button type="submit" name="downloadreport" class="btn btn-inverse btn-sm btn-round tooltip-btn disabled" data-toggle="tooltip" data-placement="bottom" title="Download Report"><i class="icofont icofont-ebook"></i> Pending Report ... </button>
                                                                ';
                                                        }
    ...
    <div class="modal fade" id="personnel-Modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <input type="hidden" name="client_id" class="form-control" placeholder="Client Id" required="required" value="<?php echo $wms_user_idStored; ?>">
