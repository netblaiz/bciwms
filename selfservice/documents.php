                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            <form action="drive_files" method="POST">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="documents" class="btn btn-primary btn-bg-c-white btn-outline-default btn-round btn-action m-r-10 m-b-10"> <i class="icofont icofont-refresh"></i> Refresh </a>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 pull-md-8">
                                                ...
                                                <!-- START PHP CORE CODE -->
                                                    <?php //include('core/pages/drive_filesController.php'); ?>
                                                <!-- END PHP CORE CODE -->
                                                ...
                                                <div class="card card-border-default">
                                                    <div class="card-header">
                                                        <!-- <h5>Upload : <?php //echo $drive_folder_unique_id; ?> </h5> -->
